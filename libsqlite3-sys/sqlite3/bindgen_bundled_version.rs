...
pub const SQLITE_SOURCE_ID: &::std::ffi::CStr =
    c"2025-09-04 16:26:49 21e4744de2cf22a6d65ed68e943a385dac0b58aa46c01db07e9abefea9463190";
pub const SQLITE_SCM_BRANCH: &::std::ffi::CStr = c"bedrock";
pub const SQLITE_SCM_TAGS: &::std::ffi::CStr = c"";
pub const SQLITE_SCM_DATETIME: &::std::ffi::CStr = c"2025-09-04T16:26:49.514Z";
...
pub const SQLITE_COMMIT_FIRSTFRAME: i32 = 0;
pub const SQLITE_COMMIT_NFRAME: i32 = 1;
pub const SQLITE_COMMIT_CONFLICT_DB: i32 = 2;
pub const SQLITE_COMMIT_CONFLICT_FRAME: i32 = 3;
pub const SQLITE_COMMIT_CONFLICT_PGNO: i32 = 4;
...
pub const SQLITE_CHANGESETSTART_FULL: i32 = 4;
...
unsafe extern "C" {
    pub fn sqlite3_commit_status(
        db: *mut sqlite3,
        zDb: *const ::std::os::raw::c_char,
        op: ::std::os::raw::c_int,
        piVal: *mut ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
}
