...
impl Serialize for AckiNackiBlockVersioned {
        ...
        S: Serializer,
    {
        match self {
            ...
            AckiNackiBlockVersioned::Old(_old) => todo!(),
        }
    }
}
...
impl AckiNackiBlockVersioned {
    pub fn seq_no(&self) -> BlockSeqNo {
        match self {
            ...
            AckiNackiBlockVersioned::Old(_acki_block) => todo!(),
        }
    }
    ...
    pub fn get_common_section(&self) -> CommonSection {
        match self {
            ...
            AckiNackiBlockVersioned::Old(_acki_block) => {
                todo!()
            }
        }
    }
    ...
    pub fn set_common_section(
        ...
        match self {
            ...
            AckiNackiBlockVersioned::Old(_an_block) => {
                todo!()
            }
        }
    }
    ...
    pub fn tvm_block(&self) -> &tvm_block::Block {
        match self {
            ...
            AckiNackiBlockVersioned::Old(_an_block) => todo!(),
        }
    }
