...
impl<'de> Deserialize<'de> for AckiNackiBlock {
        ...
        D: Deserializer<'de>,
    {
        ...
        let (mut common_section, is_new): (CommonSection, bool) =
        ...
        if !is_new {
            let parent = BlockIdentifier::from(
                block
                    .info
                    .read_struct()
                    .unwrap()
            ...
            common_section.set_parent_block_id(parent);
        }
        ...
        if is_new {
            ...
            block.cached_block_id = Some(block.tvm_block_hash());
        }
        Ok(block)
    }
}
