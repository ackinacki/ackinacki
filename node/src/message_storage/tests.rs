...
mod tests {
    ...
    fn test_get_rowid_by_hash() {
        let db_path = tempfile::tempdir().unwrap().into_path().join("test_get_rowid_by_hash.db");
        let storage = setup_db(db_path);
    ...
    #[test]
    fn test_next_simple() {
        let db_path = tempfile::tempdir().unwrap().into_path().join("test_next_simple.db");
        let storage = setup_db(db_path);
    ...
    #[test]
    fn test_remaining() {
        let db_path = tempfile::tempdir().unwrap().into_path().join("test_remaining.db");
        let storage = setup_db(db_path);
