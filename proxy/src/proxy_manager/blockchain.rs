...
/// https://github.com/gosh-sh/acki-nacki/blob/dev/contracts/0.79.3_compiled/bksystem/BlockKeeperEpochProxyList.abi.json
/// https://github.com/gosh-sh/acki-nacki/blob/dev/contracts/0.79.3_compiled/bksystem/BlockKeeperContractRoot.abi.json
/// Fetches the list of proxy servers from the blockchain
pub async fn get_proxy_list() -> anyhow::Result<SocketAddrSet> {
