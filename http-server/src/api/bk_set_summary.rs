...
pub struct BkSetSummaryHandler<TBPResolver, TSeqnoGetter>(
    PhantomData<TBPResolver>,
    PhantomData<TSeqnoGetter>,
);

impl<TBPResolver, TSeqnoGetter> BkSetSummaryHandler<TBPResolver, TSeqnoGetter> {
    pub fn new() -> Self {
...
#[async_trait]
impl<TBPResolver, TSeqnoGetter> Handler for BkSetSummaryHandler<TBPResolver, TSeqnoGetter>
where
