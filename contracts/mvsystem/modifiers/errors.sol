...
abstract contract Errors {
    ...
    uint16 constant ERR_NO_SALT = 400;
    uint16 constant ERR_ALREADY_PLAY = 401;
    uint16 constant ERR_NOT_OWNER = 402;
    uint16 constant ERR_MESSAGE_EXPIRED = 403;
    uint16 constant ERR_MESSAGE_WITH_HUGE_EXPIREAT = 404;
    uint16 constant ERR_MESSAGE_IS_EXIST = 405;
    uint16 constant ERR_LOW_VALUE = 406;
    uint16 constant ERR_INVALID_SENDER = 407;
    uint16 constant ERR_LOW_BALANCE = 408;
    uint16 constant ERR_NOT_READY = 409;
    uint16 constant ERR_WRONG_DATA = 410;
    uint16 constant ERR_BUSY = 411;
    uint16 constant ERR_WRONG_ADDRESS = 412;
    uint16 constant ERR_ALREADY_EXIST = 413;
    uint16 constant ERR_NOT_PUBLIC = 414;
    uint16 constant ERR_ALREADY_READY = 415;
